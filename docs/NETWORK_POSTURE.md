...
| 0c. The app asking about itself | Nothing about you or your documents. A GET to the project's own release host, and then the archive | Shipped, the Mac app only, on by default | Birta Writer for Mac's update check (`autoUpdate`) |
...
### The Mac app updating itself: a rung of its own, and on by default
