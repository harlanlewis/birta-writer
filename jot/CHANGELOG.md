...
- Your Checks choices are remembered. Turning off a category, or the whole pass, used to last until the next time the panel loaded a file, which for this app is often. They now survive that and a restart.
