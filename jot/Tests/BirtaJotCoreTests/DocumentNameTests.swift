...
final class DocumentNameTests: XCTestCase {
    func testANewStemKeepsTheExtensionItHadBefore() {
        ...
        XCTAssertEqual(DocumentName.resolve(typed: "Notes", current: "Birta Writer Jot.md"),
                       .rename(to: "Notes.md"))
    }

    func testATypedExtensionIsTheirsToChoose() {
        XCTAssertEqual(DocumentName.resolve(typed: "Notes.txt", current: "Birta Writer Jot.md"),
                       .rename(to: "Notes.txt"))
    }

    func testTheSameNameIsNotARename() {
        XCTAssertEqual(DocumentName.resolve(typed: "Birta Writer Jot.md", current: "Birta Writer Jot.md"),
                       .unchanged)
    }
    ...
    func testTheSameStemIsNotARenameEither() {
        ...
        XCTAssertEqual(DocumentName.resolve(typed: "Birta Writer Jot", current: "Birta Writer Jot.md"),
                       .unchanged)
    }
    ...
    func testAnEmptyNameIsRejected() {
        guard case .rejected = DocumentName.resolve(typed: "   ", current: "Birta Writer Jot.md") else {
    ...
    func testAPathSeparatorIsRejectedRatherThanStripped() {
        ...
        for typed in ["a/b.md", "a:b.md"] {
            guard case .rejected = DocumentName.resolve(typed: typed, current: "Birta Writer Jot.md") else {
    ...
    func testALeadingDotIsAStemAndNotABareExtension() {
        ...
        XCTAssertEqual(DocumentName.resolve(typed: ".hidden", current: "Birta Writer Jot.md"),
                       .rename(to: ".hidden.md"))
    }
