...
final class DocumentNameTests: XCTestCase {
    func testANewStemKeepsTheExtensionItHadBefore() {
        ...
        XCTAssertEqual(DocumentName.resolve(typed: "Notes", current: "Birta Jot.md"),
                       .rename(to: "Notes.md"))
    }

    func testATypedExtensionIsTheirsToChoose() {
        XCTAssertEqual(DocumentName.resolve(typed: "Notes.txt", current: "Birta Jot.md"),
                       .rename(to: "Notes.txt"))
    }

    func testTheSameNameIsNotARename() {
        XCTAssertEqual(DocumentName.resolve(typed: "Birta Jot.md", current: "Birta Jot.md"),
                       .unchanged)
    }
    ...
    func testTheSameStemIsNotARenameEither() {
        ...
        XCTAssertEqual(DocumentName.resolve(typed: "Birta Jot", current: "Birta Jot.md"),
                       .unchanged)
    }
    ...
    func testAnEmptyNameIsRejected() {
        guard case .rejected = DocumentName.resolve(typed: "   ", current: "Birta Jot.md") else {
    ...
    func testAPathSeparatorIsRejectedRatherThanStripped() {
        ...
        for typed in ["a/b.md", "a:b.md"] {
            guard case .rejected = DocumentName.resolve(typed: typed, current: "Birta Jot.md") else {
    ...
    func testALeadingDotIsAStemAndNotABareExtension() {
        ...
        XCTAssertEqual(DocumentName.resolve(typed: ".hidden", current: "Birta Jot.md"),
                       .rename(to: ".hidden.md"))
    }
