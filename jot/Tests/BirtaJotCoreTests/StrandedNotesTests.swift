...
final class StrandedNotesTests: XCTestCase {
    ...
    /// The folder it produced under a former product name. A literal, because
    /// a name that is gone is spelled nowhere the code can be asked for it,
    /// which is the whole reason the comparison needs something recorded.
