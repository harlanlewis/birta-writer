...
final class NoteNameTemplateTests: XCTestCase {
    ...
    func testTheDefaultTemplateShouldNameTheNoteByDay() {
        XCTAssertEqual(expand(NoteNameTemplate.default), "Jot 2026-08-20.md")
    }
    ...
    func testATemplateThatExpandsToNothingShouldFallBackRatherThanFail() {
        ...
        // a template meant.
        XCTAssertEqual(expand(""), "Jot 2026-08-20.md")
        XCTAssertEqual(expand("   "), "Jot 2026-08-20.md")
        XCTAssertEqual(expand(".md"), "Jot 2026-08-20.md")
        for template in ["", "   ", ".md", "/", ":"] {
    ...
    func testTheExtensionShouldBeAddedButNeverDoubled() {
        XCTAssertEqual(expand("Jot"), "Jot.md")
        XCTAssertEqual(expand("Jot.md"), "Jot.md")
        XCTAssertEqual(expand("Jot.MD"), "Jot.MD")
        XCTAssertEqual(expand("Jot.txt"), "Jot.txt.md")
    }
    ...
    func testPartsShouldSplitWhereTheCollisionNumbererExpectsIt() {
        ...
        // `Jot 2026-08-20.md 2` rather than `Jot 2026-08-20 2.md`.
        let parts = NoteNameTemplate.parts(NoteNameTemplate.default, at: noon, timeZone: utc)
        XCTAssertEqual(parts.stem, "Jot 2026-08-20")
