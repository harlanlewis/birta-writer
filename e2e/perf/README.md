...
A missing column on either side of an A/B — a merge-base predating the metric — is **skipped, never read as a zero baseline**, which would make every comparison against an older commit a 100% regression.
