...
final class NotesMoveOfferLaunchTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        try noteBody.write(to: former.appendingPathComponent("Birta Writer Legacy.md"),
    ...
    private let formerScratchpadName = "Birta Writer Legacy.md"
    ...
    func testLeavingThemShouldMoveNothingAndStillRecord() {
        ...
        XCTAssertTrue(exists(former.appendingPathComponent("Birta Writer Legacy.md")))
        XCTAssertFalse(exists(derived.appendingPathComponent("Birta Writer Legacy.md")))
        XCTAssertEqual(answers.recorded, [derived])
    }
    ...
    func testAnEmptyFolderLeftByARenameShouldRaiseNothing() throws {
        let empty = root.appendingPathComponent("Birta Writer Legacy Dev", isDirectory: true)
    ...
    func testTheLaunchShouldReachThisAtAll() throws {
        let app = URL(fileURLWithPath: #filePath)
            ...
            .appendingPathComponent("Sources/BirtaWriter/App.swift")
