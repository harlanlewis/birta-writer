...
final class ActiveBindingTests: XCTestCase {
    private let doc = URL(fileURLWithPath: "/tmp/mac-test/Chosen.md")
    private let note = URL(fileURLWithPath: "/tmp/mac-test/Note.md")
    private let pad = URL(fileURLWithPath: "/tmp/mac-test/Birta Writer.md")
