...
public enum ReleaseFeed {
    ...
    public static func parse(_ data: Data) -> Release? {
        ...
        // then verify it against a checksum for the other. `update.sh`
