...
/// wrong.
///
/// SCOPE. `Prefs.notesDirectory` is the scratchpad's PARENT folder, which the
/// app does not exclusively own. So this never moves a directory wholesale. It
...
public enum NotesMove {
    ...
    /// Extensions the app treats as a note worth carrying.
    ///
    ...
    /// and iCloud, and is not something the app can wait for.
    ///
