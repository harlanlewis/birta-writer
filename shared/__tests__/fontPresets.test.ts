...
describe("resolveFontFamily", () => {
    it("each stack preset should return its own stack", () => {
    ...
    it("the editor preset should return null (inherit the VS Code editor font)", () => {
        expect(resolveFontFamily("editor")).toBeNull();
        expect(resolveFontFamily("editor", { ...FONT_PRESET_STACKS, serif: "X" })).toBeNull();
    });
