...
import { parseWikiRaw } from "../../shared/wikiRaw";

export const wikiLinkId = "wiki_link";

// The raw-bytes reading lives in shared/ so the host's folder index splits a
// wikilink exactly as the chip does; re-exported for the page's importers.
export { parseWikiRaw, wikiDisplayText, type WikiRawParts } from "../../shared/wikiRaw";
