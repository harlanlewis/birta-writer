...
declare global {
    interface Window {
        __i18n?: {
             ...
             * setting changed in the host's own Settings window or asked
             * for by a page's gear switch (`setFormattingRowExpanded` out),
             * and pushed to every page as `setFormattingRowExpanded`; no
             * page flips the row on its own.
             */
