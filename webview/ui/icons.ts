...
// "calculator": a keypad — for the ```calc living-calculation block.
export const IconCalculator = svg(`<rect width="16" height="20" x="4" y="2" rx="2"/><line x1="8" y1="6" x2="16" y2="6"/><line x1="16" y1="14" x2="16" y2="18"/><path d="M8 10h.01"/><path d="M12 10h.01"/><path d="M8 14h.01"/><path d="M12 14h.01"/><path d="M8 18h.01"/><path d="M12 18h.01"/>`);
...
// "calendar": a page with two binding posts and a ruled head.
export const IconCalendar = svg(`<rect x="3" y="4" width="18" height="18" rx="2"/><path d="M16 2v4"/><path d="M8 2v4"/><path d="M3 10h18"/>`);
...
/** Arrow down to a line — "move checked to bottom" (checklist sink). */
export const IconArrowDownToLine = svg(`<path d="M12 3v12"/><polyline points="6 9 12 15 18 9"/><line x1="4" y1="21" x2="20" y2="21"/>`);
...
export const IconEllipsis = svg(`<circle cx="12" cy="12" r="1"/><circle cx="19" cy="12" r="1"/><circle cx="5" cy="12" r="1"/>`);
...
// The closed folder: the file explorer's bar button (MAR-460). Closed rather
// than open because the button names the panel, not a folder being looked into.
export const IconFolder      = svg(`<path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z"/>`);
...
// "AI chat": a chat bubble with a four-point sparkle at its corner — the
// sparkle being the established AI marker. For the copy-agent-reference button.
export const IconAgentChat   = svg(`<path d="M12.5 3H5a2 2 0 0 0-2 2v16l4-4h12a2 2 0 0 0 2-2v-4.5"/><path d="M18.5 2.5l1 2.5 2.5 1-2.5 1-1 2.5-1-2.5-2.5-1 2.5-1z"/>`);
