...
- Open Link is a palette command now (`birta.editor.openLink`), so following the link at the caret can be given a keybinding of your own. It routes exactly like Cmd+Click.
