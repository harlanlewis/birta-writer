...
- **Every style check is on by default**: passive voice and negative parallelism, previously off because they can flag correct English ("was born", "is located", "not only X but also Y"), now ship on like the rest. If they get noisy, turn them off individually in the Checks menu or use "Turn off proofreading".
